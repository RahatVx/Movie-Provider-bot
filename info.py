...
PICS = (environ.get('PICS', 'https://envs.sh/346.jpg https://envs.sh/34V.jpg')).split() #SAMPLE PIC
...
CODE = (environ.get('CODE', 'https://envs.sh/346.jpg'))
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '1002267822942').split()] #Channel id for auto indexing ( make sure bot is admin )
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002470486707') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002381997635') # request channel id ( make sure bot is admin )
...
HOWTOVERIFY = environ.get('HOWTOVERIFY', 'https://t.me/RahatVx') # How to open tutorial link for verification
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/RM_Movie_Flix') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : RM Movie Flix')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002381997635')) #Log channel id ( make sure bot is admin )
